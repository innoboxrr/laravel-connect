...
class EventServiceProvider extends ServiceProvider
{
    ...
    {
        $cacheKey = 'laravel_connect_events_and_observers';
    ...
    protected function customDiscoverEvents()
    {
        ...
        $namespace = 'Innoboxrr\LaravelConnect\Http\Events\\';
    ...
    protected function customDiscoverObservers()
    {
        ...
        $namespaceModel = 'Innoboxrr\LaravelConnect\Models\\';
        $namespaceObserver = 'Innoboxrr\LaravelConnect\Observers\\';
