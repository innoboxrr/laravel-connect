...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function mapPolicies()
    {
        ...
        $cacheKey = 'laravel_connect_auth_policies';
    ...
    protected function customDiscoverPolicies()
    {
        ...
        foreach (glob(__DIR__ . '/../Policies/*.php') as $file) {
            $policy = 'Innoboxrr\LaravelConnect\Policies\\' . substr(basename($file), 0, -4);
            $model = 'Innoboxrr\LaravelConnect\Models\\' . str_replace('Policy', '', $policy);
