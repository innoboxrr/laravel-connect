...
class PolicyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'id' => [
                'numeric',
                'exists:Innoboxrr\LaravelConnect\Models\PlatformConnection,id',
    ...
    public function handle()
    {
         ...
         $platformConnection = ($this->id) ? 
            PlatformConnection::findOrFail($this->id) : 
            app(PlatformConnection::class);

        return response()->json([
            $this->policy => $this->user()->can($this->policy, $platformConnection),
        ]);
