...
class PoliciesRequest extends FormRequest
{
    ...
    {
        return [
            'id' => 'nullable|numeric|exists:Innoboxrr\LaravelConnect\Models\PlatformConnection,id'
        ];
    }
    ...
    public function handle($controllerClass)
    {
        ...
        $model = ($this->id) ? PlatformConnection::findOrFail($this->id) : app(PlatformConnection::class);
