...
namespace Innoboxrr\LaravelConnect\Http\Resources\Models;
...
class PlatformConnectionResource extends JsonResource
{
    ...
    private function view() 
    {
        return [
            'id' => 'view',
            'name' => 'Ver',
            'callback' => 'viewPlatformConnection',
            'icon' => 'fa-eye',
            'route' => true,
            'policy' => false,
            'params' => [
                'id' => $this->id,
                'to' => [
                    'name' => 'AdminShowPlatformConnection',
                    'params' => [
                        'id' => $this->id
                    ]
                ]
    ...
    private function edit()
    {
        return [
            'id' => 'update',
            'name' => 'Editar',
            'callback' => 'editPlatformConnection',
            'icon' => 'fa-edit',
            'route' => true,
            'policy' => false,
            'params' => [
                'id' => $this->id,
                'to' => [
                    'name' => 'AdminEditPlatformConnection',
                    'params' => [
                        'id' => $this->id
                    ]
                ]
